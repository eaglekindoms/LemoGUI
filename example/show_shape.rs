...
impl Instance for Board {
    ...
    fn layout(&self) -> Panel<()> {
        ...
        let triangle = RegularPolygon::new(Circle::new(331., 560.2, 100.2), 3);

        let polygon = RegularPolygon::new(Circle::new(131., 510.2, 110.2), 6);

        let rects = RegularPolygon::new(Circle::new(631., 510.2, 110.2), 4);
